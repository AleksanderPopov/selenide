...
public class SetValue implements Command<WebElement> {
    ...
    public WebElement execute(SelenideElement proxy, WebElementSource locator, Object[] args) {
        ...
        if (useSetValueForSelect || "select".equalsIgnoreCase(element.getTagName())) {
            selectOptionByValue.execute(proxy, locator, args);
        }
        else if (useSetValueForRadio || "input".equalsIgnoreCase(element.getTagName()) && "radio".equals(element.getAttribute("type"))) {
